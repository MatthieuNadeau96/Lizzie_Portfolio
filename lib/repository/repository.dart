...
List<ProjectModel> getProjects() {
  List<ProjectModel> projects = [
    ProjectModel(
      ...
      image: 'images/graphic-design/tri-fold-business-pamphlet.png',
    ),
    ProjectModel(
      ...
      image: 'images/graphic-design/logo-design.png',
    ),
    ProjectModel(
      ...
      image: 'images/graphic-design/promotional-poster.png',
    ),
    ProjectModel(
      title:
      ...
      image: 'images/graphic-design/gelato-espresso.png',
      carouselImages: [
        'images/graphic-design/gelato-blueberry.png',
        'images/graphic-design/gelato-caramel.png',
        'images/graphic-design/gelato-espresso.png',
        'images/graphic-design/gelato-ginger-tumeric-black-pepper.png',
        'images/graphic-design/gelato-honey.png',
        'images/graphic-design/gelato-hot-chocolate.png',
        'images/graphic-design/gelato-lemon.png',
        'images/graphic-design/gelato-mint-chocolate.png',
        'images/graphic-design/gelato-peppermint.png',
      ],
    ),
    ProjectModel(
      ...
      image: 'images/graphic-design/gig-poster-1.png',
    ),
    ProjectModel(
      ...
      image:
          'images/graphic-design/label-background-for-the-vermont-gelato-company.png',
    ),
    ProjectModel(
      ...
      image: 'images/graphic-design/pattern-swatch.png',
    ),
    ProjectModel(
      ...
      image: 'images/graphic-design/promotional-postcard-back.png',
    ),
    ProjectModel(
      ...
      image: 'images/graphic-design/promotional-postcard-front.png',
    ),
    ProjectModel(
      ...
      image: 'images/graphic-design/sbsd-healthy-schools-program.png',
    ),
    ProjectModel(
      ...
      image: 'images/graphic-design/gig-poster-2.png',
    ),
    ProjectModel(
      title: 'VCD mac',
      description:
    ...
    ProjectModel(
      ...
      image: 'images/graphic-design/restroom-door-signage.png',
    ),
    ProjectModel(
      ...
      image: 'images/graphic-design/coffee-card-design.png',
    ),
    ProjectModel(
      ...
      image: 'images/graphic-design/store-signage.png',
    ),
    ProjectModel(
      title: 'Store Signage for the Vermont Country Deli and Market (2)',
      description:
          'I drew the outlines by hand and then brought it all onto the computer to arrange and color. (Made using Adobe Illustrator)',
      image: 'images/graphic-design/store-signage-2.png',
    ),
    ProjectModel(
